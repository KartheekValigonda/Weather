...
class Chandigarh extends StatefulWidget{
  const Chandigarh({super.key});

  @override
  State<Chandigarh> createState() => _FirstState();
}

class _FirstState extends State<Chandigarh> {
  ...
  Future<void> getCurrentWeather() async{
    try{
      ...
      final res = await http.get(
        Uri.parse('https://api.openweathermap.org/data/2.5/forecast?q=Chandigarh&APPID=f905fe9e61013cb322bd4b6a6f940def'),);
