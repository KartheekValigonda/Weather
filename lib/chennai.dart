...
class Chennai extends StatefulWidget{
  ...
  @override
  State<Chennai> createState() => _FirstState();
}

class _FirstState extends State<Chennai> {
  ...
  Future<void> getCurrentWeather() async{
    try{
      ...
      final res = await http.get(
        Uri.parse('https://api.openweathermap.org/data/2.5/forecast?q=Chennai&APPID=f905fe9e61013cb322bd4b6a6f940def'),);
    ...
    return Scaffold(
      ...
      body: isLoading ? Center(child: const CircularProgressIndicator()):Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              Text("Chennai", style: TextStyle(fontSize:22 ),),
              SizedBox(height: 10,),
              Material(
                elevation: 12,
